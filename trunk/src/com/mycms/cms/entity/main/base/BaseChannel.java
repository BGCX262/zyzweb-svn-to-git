...
public abstract class BaseChannel  implements Serializable {
	...
	public BaseChannel (
		...
		com.mycms.cms.entity.main.CmsModel model,
	...
	// one to one
	private com.mycms.cms.entity.main.ChannelExt channelExt;

	// many to one
	private com.mycms.cms.entity.main.CmsSite site;
	private com.mycms.cms.entity.main.CmsModel model;
	private com.mycms.cms.entity.main.Channel parent;

	// collections
	private java.util.Set<com.mycms.cms.entity.main.Channel> child;
	private java.util.Set<com.mycms.cms.entity.main.CmsGroup> viewGroups;
	private java.util.Set<com.mycms.cms.entity.main.CmsGroup> contriGroups;
	private java.util.Set<com.mycms.cms.entity.main.CmsUser> users;
	private java.util.Set<com.mycms.cms.entity.main.ChannelTxt> channelTxtSet;
	 ...
	 */
	public com.mycms.cms.entity.main.ChannelExt getChannelExt () {
		return channelExt;
	}
	 ...
	 */
	public void setChannelExt (com.mycms.cms.entity.main.ChannelExt channelExt) {
	 ...
	 */
	public com.mycms.cms.entity.main.CmsModel getModel () {
		return model;
	}
	 ...
	 */
	public void setModel (com.mycms.cms.entity.main.CmsModel model) {
		this.model = model;
	}
	 ...
	 */
	public com.mycms.cms.entity.main.Channel getParent () {
		return parent;
	}
	 ...
	 */
	public void setParent (com.mycms.cms.entity.main.Channel parent) {
		this.parent = parent;
	}
	 ...
	 */
	public java.util.Set<com.mycms.cms.entity.main.Channel> getChild () {
		return child;
	}
	 ...
	 */
	public void setChild (java.util.Set<com.mycms.cms.entity.main.Channel> child) {
		this.child = child;
	}
	 ...
	 */
	public java.util.Set<com.mycms.cms.entity.main.CmsGroup> getContriGroups () {
		return contriGroups;
	}
	 ...
	 */
	public void setContriGroups (java.util.Set<com.mycms.cms.entity.main.CmsGroup> contriGroups) {
	 ...
	 */
	public java.util.Set<com.mycms.cms.entity.main.CmsUser> getUsers () {
		return users;
	}
	 ...
	 */
	public void setUsers (java.util.Set<com.mycms.cms.entity.main.CmsUser> users) {
		this.users = users;
	}
	 ...
	 */
	public java.util.Set<com.mycms.cms.entity.main.ChannelTxt> getChannelTxtSet () {
	 ...
	 */
	public void setChannelTxtSet (java.util.Set<com.mycms.cms.entity.main.ChannelTxt> channelTxtSet) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.mycms.cms.entity.main.Channel)) return false;
		else {
			com.mycms.cms.entity.main.Channel channel = (com.mycms.cms.entity.main.Channel) obj;
