...
public abstract class BaseCmsModel  implements Serializable {
	...
	// collections
	private java.util.Set<com.mycms.cms.entity.main.CmsModelItem> items;
	 ...
	 */
	public java.util.Set<com.mycms.cms.entity.main.CmsModelItem> getItems () {
		return items;
	}
	 ...
	 */
	public void setItems (java.util.Set<com.mycms.cms.entity.main.CmsModelItem> items) {
		this.items = items;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.mycms.cms.entity.main.CmsModel)) return false;
		else {
			com.mycms.cms.entity.main.CmsModel cmsModel = (com.mycms.cms.entity.main.CmsModel) obj;
