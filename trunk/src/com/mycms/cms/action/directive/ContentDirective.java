...
import static com.mycms.common.web.freemarker.DirectiveUtils.OUT_BEAN;
...
public class ContentDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		ContentTxt ctxt=content.getContentTxt();
		String txt = cmsKeywordMng.attachKeyword(site.getId(), ctxt.getTxt());
		txt=cmsSensitivityMng.replaceSensitivity(txt);
		ctxt.setTxt(txt);
		content.setContentTxt(content.getContentTxt());
