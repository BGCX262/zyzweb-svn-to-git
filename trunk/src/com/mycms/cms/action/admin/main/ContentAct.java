...
import com.mycms.cms.manager.main.CmsTopicMng;
import com.mycms.cms.manager.main.CmsUserMng;
import com.mycms.cms.manager.main.ContentMng;
import com.mycms.cms.manager.main.ContentTypeMng;
...
public class ContentAct {
	...
	@RequestMapping("/downloadcnt/v_list.do")
	public String list1(String queryStatus, Integer queryTypeId,
			Boolean queryTopLevel, Boolean queryRecommend,
			Integer queryOrderBy, Integer cid, Integer pageNo,
			HttpServletRequest request, ModelMap model) {
		String queryTitle = RequestUtils.getQueryParam(request, "queryTitle");
	...
	public String uploadAttachment(
		...
		try {
			...
			if (site.getConfig().getUploadToDb()) {
				...
				fileUrl = fileRepository.storeByExt1(site.getUploadPath(), ext,
						file);
				// 加上部署路径
				fileUrl = ctx + fileUrl;
			}
