...
import com.mycms.common.util.Num62;
...
public class UploadUtils {
	...
	public static final DateFormat MONTH_FORMAT = new SimpleDateFormat(
			"/yyyyMM/ddHHmmss");
	public static final DateFormat MONTH_FORMAT1 = new SimpleDateFormat(
	"/yyyyMMddHHmmss/");
	public static final DateFormat MONTH_FORMAT2 = new SimpleDateFormat(
	"/yyyyMMddHHmmss");
	...
	public static String generateFilename1(String path, String ext) {
		return path + MONTH_FORMAT2.format(new Date())
				+ RandomStringUtils.random(4, Num62.N36_CHARS) + "." + ext;
	}
	public static String generateFilename(String path, String ext,String filename) {
		return path + MONTH_FORMAT1.format(new Date())
				+ filename + "." + ext;
	}
