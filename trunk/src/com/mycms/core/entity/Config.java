...
import com.mycms.core.entity.base.BaseConfig;
...
public class Config extends BaseConfig {
	...
	public static class ConfigMessageTemplate implements MessageTemplate {
		...
		public static ConfigMessageTemplate create(Map<String, String> map) {
			if (map == null || StringUtils.isBlank(map.get(MESSAGE_SUBJECT))
					|| StringUtils.isBlank(map.get(MESSAGE_TEXT))) {
				// 信息不完整，返回null。
				return null;
			}
		...
		public String getSubject() {
			return getAttr().get(MESSAGE_SUBJECT);
		}

		public void setSubject(String subject) {
			getAttr().put(MESSAGE_SUBJECT, subject);
		}

		public String getText() {
			return getAttr().get(MESSAGE_TEXT);
		}

		public void setText(String text) {
			getAttr().put(MESSAGE_TEXT, text);
		}
	}
