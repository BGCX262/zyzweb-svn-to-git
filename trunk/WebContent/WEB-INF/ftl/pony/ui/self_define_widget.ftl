...
<#if type=="1" || type=="2" || type=="3">
	...
	<#if name=="attr_softsize" || name=="attr_softversion" >
	<#local required="true"/>
	<#else>
	<#local required="false"/>
	</#if>
	<@p.text colspan=colspan width=width label=label name=name required=required value=value size=size help=help helpPosition=helpPosition vld=vld/>
<#elseif type=="4">
