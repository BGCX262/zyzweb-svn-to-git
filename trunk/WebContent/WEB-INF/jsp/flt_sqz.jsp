...
<div class="body-box">
<div class="rhead">
		<div class="rpos">当前位置: -申请中党员分组饼状图 </div>

	<div class="clear"></div>
</div>
<form id="jvForm" action="fl_sqz.do" onsubmit="setValue()" method="post" style="padding-top:5px;">
 <input type="hidden" name="t" id="t" value="<c:out value="${t}"/>" />
  ...
  <select  name="G0005" >
   	...
   	<strong>统计分组：</strong>   
  <select  name="flid" >
         <option value="A0117"  > 民族</option>
          <option value="nl"  > 年龄段</option>
              </select>
<!-- 子分组：
  <select  name="nl" >
         <option   value="" > --请选择--</option>
 ...
 统计项目：
  <select  name="flvalue" >
         <option   value="cservicetimes" > 服务时长</option>
         <option   value="sqzrs" > 申请中党员人数</option>
 <option   value="cscore" > 积分</option>
 </select>
   	</br>
	<hr></hr>
