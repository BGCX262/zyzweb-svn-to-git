                                ...
                                <div id="jp-container" class="jp-container">
                                    ...
                                    <div class="mainBox">
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <th width="120" height="45" bgcolor="#F3F3F3">姓名</th>
                                                <th width="650" bgcolor="#F3F3F3">内容</th>
                                                <th width="170" bgcolor="#F3F3F3">日期</th>
                                            </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                    	<c:if test="${row.itemType==2}">
                                                                承诺捐助了${row.amount}元给  &nbsp;<a href="/zyztbitem/zyztbitemEdit.do?actiontype=view_f&itemid=${row.itemid}">${row.itemTitle}</a>  &nbsp;项目
                                                        </c:if>
                                                        <c:if test="${row.itemType==3}">
                                                                承诺捐助了  &nbsp;<a href="/zyztbitem/zyztbitemEdit.do?actiontype=view_f&itemid=${row.itemid}">${row.itemTitle}</a>  &nbsp;项目
                                                        </c:if>
                                                        <c:if test="${row.itemType==1}">
                                                            承诺报名了  &nbsp;<a href="/zyztbitem/zyztbitemEdit.do?actiontype=view_f&itemid=${row.itemid}">${row.itemTitle}</a>  &nbsp;项目
                                                        </c:if>
                                                    </td>
                                                    <td align="center">${row.createdate.year+1900}-${row.createdate.month+1}-${row.createdate.date}</td>
                                                </tr>
                                            </c:forEach>
                                        </table>
                                        <div class="clear"></div>
