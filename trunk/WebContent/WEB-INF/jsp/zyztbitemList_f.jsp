...
<div class="body-box">
<div class="rhead">
	<div class="rpos">当前位置: 志愿淘宝商品信息 - 列表</div>
...
<thead class="pn-lthead"><tr>
	<th width="20"><input type='checkbox' onclick='Pn.checkbox("ids",this.checked)'/></th>      	 <th>捐献对象</th>
   	 <th>标题</th>
   	 <th>目标金额</th>
...
<tr>
 ...
 <td><c:out value="${row.targetamount}"/></td>
 <td><c:out value="${row.status}"/></td>
   ...
   |<a href="zyztbitemRemove.do?isfront=0&ids=<c:out value="${row.itemid}"/>" onclick="if(!confirm('您确定删除吗？')) {return false;}" class="pn-opt">删除</a>
     </c:if>
   </td>
</tr>
</c:forEach>  
