...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>  
 ...
 <c:when test="${isRoot}">  
[{
	"text": "<a href='/zyzinfo/queryDzzDy.do?order=desc&sort=cscore' target='rightFrame1'>党组织机构树</a>",
	"classes": "folder"
	...
	<c:forEach items="${list}" var="row" varStatus="status">  
		{
		"text": "<a href='/zyzinfo/queryDzzDy.do?order=desc&sort=cscore&zzcode=${row.d0107}' target='rightFrame1'>${row.d0101}</a>",
