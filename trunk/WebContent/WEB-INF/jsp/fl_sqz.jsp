...
<div class="body-box">
<div class="rhead">
		<div class="rpos">当前位置: -申请中党员分组排序 </div>
...
<tr>
 <td>
 <c:if test="${param.flid=='A0117'}">
 <c:out value="${row.a01_a0117_Dict[row.flname]}"/>
 </c:if>
 <c:if test="${param.flid=='nl'}">
 <c:out value="${row.nlFromFlName}"/>
 </c:if>

 </td>
<%--  <td><c:out value="${row.nl}"/></td> --%>
  <td><c:out value="${row.rs}"/></td>
